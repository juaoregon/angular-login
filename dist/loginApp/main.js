...
module.exports = "<h1>Log In</h1>\n<form  (ngSubmit)=\"login(loginForm)\" #loginForm=\"ngForm\" >\n  <div class=\"form-group\">\n    <label for=\"email\">Email address</label>\n    <input\n      class=\"form-control\"\n      type=\"email\"\n      name=\"email\"\n      placeholder=\"Email\"\n      [(ngModel)]=\"user.email\"\n      required\n      email>\n      <span *ngIf=\"loginForm.submitted && loginForm.controls.email.errors\" class=\"text-danger\">\n        Email must be valid\n      </span>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password</label>\n    <input\n      class=\"form-control\"\n      type=\"password\"\n      name=\"password\"\n      placeholder=\"Password\"\n      [(ngModel)]=\"user.password\"\n      required\n      minlength=\"6\">\n      <span *ngIf=\"loginForm.submitted && loginForm.controls.password.errors\" class=\"text-danger\">\n        Password must be at least 6 characters long\n      </span>\n  </div>\n  <div>\n    <a routerLink=\"/register\">\n      Don't have an account? Sign up!\n    </a>\n  </div>\n  <br>\n  <button type=\"submit\" class=\"btn btn-primary\">Log in</button>\n</form>\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.user = new _models_user_model__WEBPACK_IMPORTED_MODULE_4__["UserModel"]();
    ...
    LoginComponent.prototype.login = function (form) {
        ...
        this.auth.logIn(this.user).subscribe(function (response) {
...
module.exports = "<h1>Sign Up</h1>\n<form (ngSubmit)=\"register(registerForm)\" #registerForm=\"ngForm\" >\n  <div class=\"form-group\">\n    <label for=\"name\">Name</label>\n    <input\n      class=\"form-control\"\n      type=\"text\"\n      name=\"name\"\n      placeholder=\"Name\"\n      [(ngModel)]=\"user.name\"\n      required\n      pattern=\"[a-zA-Z0-9]*\"\n      maxlength=\"31\">\n      <span *ngIf=\"registerForm.submitted && registerForm.controls.name.errors\" class=\"text-danger animated fadeIn\">\n        Name must not contain special characters or whitespaces and must be shorter than 32 characters\n      </span>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"email\">Email address</label>\n    <input\n      class=\"form-control\"\n      type=\"email\"\n      name=\"email\"\n      placeholder=\"Email\"\n      [(ngModel)]=\"user.email\"\n      required\n      email>\n      <span *ngIf=\"registerForm.submitted && registerForm.controls.email.errors\" class=\"text-danger animated fadeIn\">\n        Email must be valid\n      </span>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password</label>\n    <input\n      class=\"form-control\"\n      type=\"password\"\n      name=\"password\"\n      placeholder=\"Password\"\n      [(ngModel)]=\"user.password\"\n      required>\n      <span *ngIf=\"registerForm.submitted && registerForm.controls.password.errors\" class=\"text-danger animated fadeIn\">\n        Password is required\n      </span>\n  </div>\n  <div>\n    <a routerLink=\"/login\">\n      Already have an account? Log in!\n    </a>\n  </div>\n  <br>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>\n"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function (form) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.showLoading();
        this.auth.register(this.user).subscribe(function (response) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.close();
            localStorage.setItem('email', _this.user.email);
            _this.router.navigateByUrl('/home');
        }, function () {
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.apiKey = 'AIzaSyCWSfwbwFjTkLwsxfqHoDQA2o4jlNo8BUc';
        this.getToken();
    }
    ...
    AuthService.prototype.logIn = function (user) {
        ...
        return this.http.post(this.url + "signInWithPassword?key=" + this.apiKey, authData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            _this.saveToken(response['idToken'], response['email']);
            return response;
        }));
    };
    AuthService.prototype.register = function (user) {
        var _this = this;
        var authData = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, user, { returnSecureToken: true });
        return this.http.post(this.url + "signUp?key=" + this.apiKey, authData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            _this.saveToken(response['idToken'], response['email']);
            return response;
        }));
    };
    AuthService.prototype.saveToken = function (idToken, email) {
...
module.exports = __webpack_require__(/*! C:\Users\juaor\Desktop\angular-login\src\main.ts */"./src/main.ts");
